...
- 求职阶段主攻 AI 产品经理，增长产品经理作为副线；商业化开发必须服务作品集可信度和后续公开发布。
...
商业化基础设施不先行实现。第一优先级是把 Reo 做成能证明 AI 产品经理能力的作品集项目：

1. 可演示 AI 工作流：从访谈、会议或研究材料生成可追溯产品洞察。
2. AI 质量评估：样本集、质量维度、幻觉率、证据引用、延迟和成本。
3. 产品 case study：用户、问题、竞品、取舍、核心切片、指标、风险和路线图。
4. 内测运营：内测群、招募问卷、任务脚本、反馈闭环和版本回访。
5. 增长副线：landing page、waitlist、激活漏斗、实验 backlog。
6. 商业化 gate：会员、支付、登录、云资源、SEO、遥测和合规进入后续阶段。
