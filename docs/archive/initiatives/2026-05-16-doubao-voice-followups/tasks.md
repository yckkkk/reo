...
- [x] **C**：自动补转录
  - brief：`docs/archive/initiatives/2026-05-16-doubao-voice-followups/c-brief.md`
...
- [x] **D**：手动重新生成转录
  - brief：`docs/archive/initiatives/2026-05-16-doubao-voice-followups/d-brief.md`
  - 归档 spec：`docs/archive/specs/2026-05-17-0950-doubao-voice-manual-regenerate-transcript/`
  - 当前状态：D 已完成实现、验证、真实 Electron runtime QA、敏感信息扫描、current docs 同步与归档。
  - 实施提交：`e87f8ce9 feat(voice): wire manual regenerate backfill mode`、`54db4529 feat(voice): add manual regenerate transcript UI`、`838b957a test(voice): close manual regenerate verification`
  - 当前合同决策（来自 spec）：
  ...
  - 收口：current docs 已同步；D→archive readiness gate 已执行

## 全部完成后

- [x] 把 initiative 移入 `docs/archive/initiatives/2026-05-16-doubao-voice-followups/`
- [x] 确认 `docs/specs/` 为空
