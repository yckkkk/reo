...
- 文件夹和文件名必须表达产品实体、能力边界或真实复用层级；Workspace、Memory、Asset 等核心实体不得被错误层级名称承载。
