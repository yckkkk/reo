...
- Segment projection 当前支持 `audio` 和 `note`，并包含 Segment cover projection。Audio Segment 持有 duration、audio byte length、transcript presence、lastTranscriptionAttempt、supplements 和 contentTabOrder；note Segment 持有 bodyByteLength、supplements 和 contentTabOrder。
