...
- Memory space stable files 包括入口 `AGENTS.md`、Reo 托管的 `skills/reo-edit/`、`skills/reo-cover-image/`、`skills/reo-cover-aesthetic/`、`skills/reo-works/`、`skills/reo-generative-runtime/`、`skills/reo-works-design/` 和 `skills/reo-doctor/`、`.reo` metadata/index/object manifests、Memory/Segment/Supplement/Widget Markdown、Memory/Segment cover payload、audio payload、note attachment payload、artifact/Widget runtime bundle、draft、trash、lock 和 recovery marker。具体路径合同以 workspace contract 与文件读写代码为准；本文档只记录所有权与真源边界。
