...
- Backfill diagnostics 只能记录 allowlist 字段：durationMs、errorCode 和 taskCount；不得记录 transcript、用户正文、title、root path、file path、raw audio bytes、audio URL、audio.data、base64 或 X-Api-Key。
