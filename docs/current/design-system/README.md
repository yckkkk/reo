...
- `DESIGN.md`：当前视觉规则、组件形态、surface、layout 和 usage rules。
...
- Runtime theme 使用 Tailwind CSS v4 `@theme inline` 暴露 shadcn/ui 语义变量。
