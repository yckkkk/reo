    ...
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          closeButton:
            'reo-toast-close absolute right-12 top-1/2 inline-flex h-24 w-24 -translate-y-1/2 items-center justify-center rounded-sm border-0 p-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background [&_svg]:h-16 [&_svg]:w-16',
          content: 'min-w-0 flex-1 pr-32',
          description: 'mt-4 text-ui-xs leading-ui-xs text-muted-foreground',
          error: 'text-popover-foreground',
          icon: 'flex h-20 w-20 shrink-0 items-center justify-center text-muted-foreground [&_svg]:h-16 [&_svg]:w-16',
          success: 'text-popover-foreground',
          title: 'text-ui-sm font-medium leading-ui-sm text-popover-foreground',
          toast:
            'reo-toast relative flex items-center gap-12 rounded-xl border-0 bg-popover px-16 py-12 text-popover-foreground shadow-float',
        },
      }}
    />
  );
