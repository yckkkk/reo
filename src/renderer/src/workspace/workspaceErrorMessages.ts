...
const workspaceErrorMessages = {
  ...
  ERR_BACKFILL_TARGET_NOT_ELIGIBLE: '这段录音已生成转录；如需覆盖，请使用「重新生成转录」。',
  ERR_BACKFILL_TRANSCRIPT_CHANGED: '转录已在生成期间发生变化，已保留当前内容。请确认后重新生成。',
  ...
  ERR_MEMORY_COVER_RESET_FAILED: '无法恢复随机默认图片。',
  ERR_MEMORY_COVER_RESTORE_FAILED: '无法恢复原封面。',
  ...
  ERR_MEMORY_SPACE_AGENT_ENTRY_MISSING: '找不到记忆空间入口文件。',
  ERR_SEGMENT_DELETE_FAILED: '无法删除片段。',
  ERR_SEGMENT_COVER_RESET_FAILED: '无法恢复随机默认图片。',
  ERR_SEGMENT_COVER_RESTORE_FAILED: '无法恢复原封面。',
  ERR_SEGMENT_RESTORE_FAILED: '无法恢复片段。',
  ERR_SEGMENT_RESTORE_PARENT_MISSING: '无法恢复片段，所属记忆已不存在。',
  ERR_SHELL_OPEN_FAILED: '无法完成系统操作。',
  ERR_SPEECH_SYNTHESIS_ALREADY_RUNNING: '这条笔记正在生成语音。',
  ERR_SPEECH_SYNTHESIS_AUDIO_TOO_LARGE: '这条笔记语音太大，暂时无法播放。',
  ERR_SPEECH_SYNTHESIS_AUTH_FAILED: '请先填写或重新保存 X-Api-Key。',
  ERR_SPEECH_SYNTHESIS_NOTE_CHANGED: '笔记已在生成期间发生变化，已保留当前内容。请确认后重新生成。',
  ERR_SPEECH_SYNTHESIS_TARGET_NOT_ELIGIBLE: '这条笔记当前无法生成语音。',
  ERR_SPEECH_SYNTHESIS_TEXT_EMPTY: '这条笔记没有可生成语音的正文。',
  ERR_SPEECH_SYNTHESIS_TEXT_TOO_LONG: '这条笔记正文过长，暂时无法生成语音。',
  ERR_SPEECH_SYNTHESIS_UNAVAILABLE: '笔记语音生成暂时不可用。',
  ERR_SPEECH_SYNTHESIS_WRITE_FAILED: '笔记语音无法写入本地文件。',
  ERR_VOICE_SETTINGS_STORAGE_UNAVAILABLE: '当前系统不可安全保存语音识别密钥。',
  ERR_VOICE_SETTINGS_WRITE_FAILED: '语音设置无法写入本地配置。',
  ERR_VOICE_SPEECH_SYNTHESIS_PROBE_FAILED: '语音生成验证失败，请确认 X-Api-Key 和音色后重试。',
  ...
  ERR_WORKSPACE_SEGMENT_COVER_NOT_FOUND: '这个片段没有自定义封面。',
