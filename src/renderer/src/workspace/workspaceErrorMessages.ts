...
const workspaceErrorMessages: Record<string, string> = {
  ...
  ERR_WORKSPACE_ALREADY_EXISTS: '同名工作区文件夹已存在。',
  ...
  ERR_WORKSPACE_PROJECT_NOT_FOUND: '找不到这个工作区项目。',
  ERR_WORKSPACE_PROJECT_REGISTRY_READ_FAILED: '无法读取工作区列表。',
  ERR_WORKSPACE_PROJECT_REGISTRY_WRITE_FAILED: '无法保存工作区列表。',
  ERR_WORKSPACE_ROOT_MISSING: '工作区文件夹已不存在。',
