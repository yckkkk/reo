  ...
  return (
    ...
    >
      <div className="flex max-w-[520px] flex-col items-center">
        <h1 className="text-balance font-memory-serif text-heading font-light leading-heading tracking-heading text-foreground xl:text-heading-lg xl:leading-heading-lg xl:tracking-heading-lg">
          {hasCurrentMemory ? currentMemory.title : '今天想记录些什么？'}
        </h1>
        <p className="mt-12 text-body-lg leading-body-lg text-muted-foreground">
          {hasCurrentMemory
