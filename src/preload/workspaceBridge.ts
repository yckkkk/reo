...
export function createWorkspaceBridge(invoker: WorkspaceBridgeInvoker): ReoWorkspaceBridge {
  ...
  const bridge: ReoWorkspaceBridge = {
    ...
    listArtifactRuntimeSecretSlots: (payload) =>
      invoke<WorkspaceBridgeResponse<'listArtifactRuntimeSecretSlots'>>(
        WORKSPACE_LIST_ARTIFACT_RUNTIME_SECRET_SLOTS_CHANNEL,
        payload
      ),
    getArtifactRuntimeSecret: (payload) =>
      invoke<WorkspaceBridgeResponse<'getArtifactRuntimeSecret'>>(
        WORKSPACE_GET_ARTIFACT_RUNTIME_SECRET_CHANNEL,
        payload
      ),
    setArtifactRuntimeSecret: (payload) =>
      invoke<WorkspaceBridgeResponse<'setArtifactRuntimeSecret'>>(
        WORKSPACE_SET_ARTIFACT_RUNTIME_SECRET_CHANNEL,
        payload
      ),
    clearArtifactRuntimeSecret: (payload) =>
      invoke<WorkspaceBridgeResponse<'clearArtifactRuntimeSecret'>>(
        WORKSPACE_CLEAR_ARTIFACT_RUNTIME_SECRET_CHANNEL,
        payload
      ),
