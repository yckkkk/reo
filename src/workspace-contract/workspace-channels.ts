...
export const WORKSPACE_LIST_ARTIFACT_RUNTIME_SECRET_SLOTS_CHANNEL =
  'workspace:listArtifactRuntimeSecretSlots' as const;
export const WORKSPACE_GET_ARTIFACT_RUNTIME_SECRET_CHANNEL =
  'workspace:getArtifactRuntimeSecret' as const;
export const WORKSPACE_SET_ARTIFACT_RUNTIME_SECRET_CHANNEL =
  'workspace:setArtifactRuntimeSecret' as const;
export const WORKSPACE_CLEAR_ARTIFACT_RUNTIME_SECRET_CHANNEL =
  'workspace:clearArtifactRuntimeSecret' as const;
