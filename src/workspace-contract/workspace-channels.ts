...
export const WORKSPACE_DELETE_SEGMENT_ATTACHMENT_CHANNEL =
  'workspace:deleteSegmentAttachment' as const;
export const WORKSPACE_RESTORE_DELETED_SEGMENT_ATTACHMENT_CHANNEL =
  'workspace:restoreDeletedSegmentAttachment' as const;
...
export const WORKSPACE_READ_FINALIZED_AUDIO_SEGMENT_ATTACHMENT_CHANNEL =
  'workspace:readFinalizedAudioSegmentAttachment' as const;
export const WORKSPACE_CREATE_RECORDING_DRAFT_CHANNEL = 'workspace:createRecordingDraft' as const;
export const WORKSPACE_CREATE_SEGMENT_ATTACHMENT_RECORDING_DRAFT_CHANNEL =
  'workspace:createSegmentAttachmentRecordingDraft' as const;
...
export const WORKSPACE_APPEND_SEGMENT_ATTACHMENT_RECORDING_AUDIO_CHUNK_CHANNEL =
  'workspace:appendSegmentAttachmentRecordingAudioChunk' as const;
...
export const WORKSPACE_FINALIZE_SEGMENT_ATTACHMENT_RECORDING_DRAFT_CHANNEL =
  'workspace:finalizeSegmentAttachmentRecordingDraft' as const;
export const WORKSPACE_DISCARD_RECORDING_DRAFT_CHANNEL = 'workspace:discardRecordingDraft' as const;
export const WORKSPACE_DISCARD_SEGMENT_ATTACHMENT_RECORDING_DRAFT_CHANNEL =
  'workspace:discardSegmentAttachmentRecordingDraft' as const;
...
export const WORKSPACE_UPDATE_SEGMENT_ATTACHMENT_TITLE_CHANNEL =
  'workspace:updateSegmentAttachmentTitle' as const;
export const WORKSPACE_SAVE_TRANSCRIPT_CHANNEL = 'workspace:saveTranscript' as const;
export const WORKSPACE_SAVE_SEGMENT_ATTACHMENT_TRANSCRIPT_CHANNEL =
  'workspace:saveSegmentAttachmentTranscript' as const;
