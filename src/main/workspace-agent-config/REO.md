...
- 创建或更新主页组件时使用 `home-components/` 下的组件目录；先读 `skills/reo-generative-runtime/SKILL.md`、`skills/reo-generative-runtime/references/` 和 `skills/reo-generative-runtime/scripts/`。
