...
import { DEFAULT_REO_WORKS_DESIGN_EXAMPLE_FILES } from './worksDesignExamples.js';
import {
...
export const DEFAULT_REO_WORKS_DESIGN_TOKEN_CSS =
  [
    // 结构地基忠实投影 Reo app theme.css（surface/zinc/radius/字体/elevation）；
    // 语义与强调色阶（info/danger/success/warning + c-* ramp）是作品自己的分类色，
    // 与 Reo 品牌色 red/magenta/ember 分离，保留不变。
    ':root {',
...
export const DEFAULT_REO_WORKS_DESIGN_EXPLORABLES_REFERENCE_MD =
  [
...
export const DEFAULT_REO_WORKS_DESIGN_REFERENCE_FILES = {
  ...
  'explorables.md': DEFAULT_REO_WORKS_DESIGN_EXPLORABLES_REFERENCE_MD,
